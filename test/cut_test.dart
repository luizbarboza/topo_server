...
void main() {
  test("cut exact duplicate lines ABC & ABC have no cuts", () {
    ...
    expect(topology["objects"], {
      ...
      "abc2": {"type": "LineString", "arcs": Arc(3, 5)}
    });
  });

  test("cut reversed duplicate lines ABC & CBA have no cuts", () {
    var topology = cut(extract({
      "abc": {
        "type": "LineString",
        "arcs": [
    ...
    expect(topology["objects"], {
      "abc": {"type": "LineString", "arcs": Arc(0, 2)},
      "cba": {"type": "LineString", "arcs": Arc(3, 5)}
    });
  });

  test("cut exact duplicate rings ABCA & ABCA have no cuts", () {
    var topology = cut(extract({
      "abca": {
        "type": "Polygon",
        "arcs": [
  ...
  test("cut reversed duplicate rings ACBA & ABCA have no cuts", () {
    var topology = cut(extract({
      "abca": {
        "type": "Polygon",
        "arcs": [
  ...
  test("cut rotated duplicate rings BCAB & ABCA have no cuts", () {
    var topology = cut(extract({
      "abca": {
        "type": "Polygon",
        "arcs": [
  ...
  test("cut ring ABCA & line ABCA have no cuts", () {
    var topology = cut(extract({
      "abcaLine": {
        "type": "LineString",
        "arcs": [
  ...
  test("cut ring BCAB & line ABCA have no cuts", () {
    var topology = cut(extract({
      "abcaLine": {
        "type": "LineString",
        "arcs": [
  ...
  test("cut ring ABCA & line BCAB have no cuts", () {
    var topology = cut(extract({
      "bcabLine": {
        "type": "LineString",
        "arcs": [
  ...
  test("cut when an old arc ABC extends a new arc AB, ABC is cut into AB-BC",
      () {
    var topology = cut(extract({
      "abc": {
        "type": "LineString",
    ...
    expect(topology["objects"], {
      ...
      "ab": {"type": "LineString", "arcs": Arc(3, 4)}
    });
  });
  ...
  test("cut degenerate ring A has no cuts", () {
    var topology = cut(extract({
      "a": {
        "type": "Polygon",
        "arcs": [
  ...
  test("cut when a new line ABC extends an old line AB, ABC is cut into AB-BC",
      () {
    var topology = cut(extract({
      "ab": {
        "type": "LineString",
    ...
    expect(topology["objects"], {
      ...
      "abc": {"type": "LineString", "arcs": Arc(2, 3, next: Arc(3, 4))}
    });
  });
  ...
  test(
    ...
    expect(topology["objects"], {
      "abc": {"type": "LineString", "arcs": Arc(0, 1, next: Arc(1, 2))},
      "bc": {"type": "LineString", "arcs": Arc(3, 4)}
    });
  });
  ...
  test(
    ...
    expect(topology["objects"], {
      "abc": {"type": "LineString", "arcs": Arc(0, 1, next: Arc(1, 2))},
      "abd": {"type": "LineString", "arcs": Arc(3, 4, next: Arc(4, 5))}
    });
  });
  ...
  test(
    ...
    expect(topology["objects"], {
      "abc": {"type": "LineString", "arcs": Arc(0, 1, next: Arc(1, 2))},
      "dbc": {"type": "LineString", "arcs": Arc(3, 4, next: Arc(4, 5))}
    });
  });
  ...
  test(
    ...
    expect(topology["objects"], {
      ...
      "abde": {
        "type": "LineString",
        "arcs": Arc(5, 6, next: Arc(6, 7, next: Arc(7, 8)))
      }
    });
  });
  ...
  test("cut when a line ABCDBE self-intersects with its middle, it is not cut",
      () {
    var topology = cut(extract({
      "abcdbe": {
        "type": "LineString",
  ...
  test("cut when a line ABCA is closed, there are no cuts", () {
    var topology = cut(extract({
      "abca": {
        "type": "LineString",
        "arcs": [
  ...
  test("cut when a ring ABCA is closed, there are no cuts", () {
    var topology = cut(extract({
      "abca": {
        "type": "Polygon",
        "arcs": [
  ...
  test("cut reversed duplicate rings ABCA & ACBA have no cuts", () {
    var topology = cut(extract({
      "abca": {
        "type": "Polygon",
        "arcs": [
  ...
  test("cut coincident rings ABCA & BCAB have no cuts", () {
    var topology = cut(extract({
      "abca": {
        "type": "Polygon",
        "arcs": [
  ...
  test("cut coincident rings ABCA & BACB have no cuts", () {
    var topology = cut(extract({
      "abca": {
        "type": "Polygon",
        "arcs": [
  ...
  test("cut overlapping rings ABCDA and BEFCB are cut into BC-CDAB and BEFC-CB",
      () {
    var topology = cut(extract({
      "abcda": {
        "type": "Polygon",
